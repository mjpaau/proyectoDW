...
class DashboardView(LoginRequiredMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'get_graph_sales_year_month':
                data = {
                    'name': 'get_graph_sales_year_month',
                    'showInLegend': False,
                    'colorByPoint': True,
    ...
    def get_graph_sales_year_month(self):
        ...
        try:
            ...
            for m in range(1, 13):
                total = Sale.objects.filter(date_joined__year=year, date_joined__month=m).aggregate(r=Coalesce(Sum('subtotal'), 0, output_field=DecimalField())).get('r')
